...
PATH = "resample/"        # Modify here for your audio directory path.
...
DICT_ENCODE_CLASS = {0: 'airport', 1: 'shopping_mall', 2: 'metro_station',3:'street_pedestrian',4:'public_square',5:'street_traffic',6:'tram',7:'bus',8:'metro',9:'park'}
DICT_CLASS_ENCODE = {'airport': 0, 'shopping_mall': 1, 'metro_station': 2,'street_pedestrian':3,'public_square':4,'street_traffic':5,'tram':6,'bus':7,'metro':8,'park':9}
...
class DCASEDataset(Dataset):
    def __init__(self, list_names, target, path, transform='', mode='train'):
        ...
        if self.mode == 'test':
            #self.classe = {'airport': 1, 'shopping_mall': 1, 'metro_station': 1, 'street_pedestrian': 0,'public_square': 0, 'street_traffic': 0 ,'tram': 2, 'bus': 2, 'metro': 2, 'park': 0}
            self.classe = {'airport': 0, 'shopping_mall': 1, 'metro_station': 2,'street_pedestrian':3,'public_square':4,'street_traffic':5,'tram':6,'bus':7,'metro':8,'park':9}
